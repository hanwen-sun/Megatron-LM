...
def _tag_muon_split_qkv_parameters(
    ...
    - `muon_split_shapes` (tuple[int, ...] | None): per-group row counts for the projection slices
      ...
      qs_grad, ks_grad, vs_grad = muon_split_grads(linear_qkv.grad, linear_qkv.muon_split_shapes)
    ...
    for model_chunk in model_chunks:
        ...
        for name, param in model_chunk.named_parameters():
            ...
            if is_managed_param:
                ...
                for attr in ("is_qkv", "muon_split_shapes"):
